...
目前部署包含 2026-06-14 Claude code review 後的修正、2026-06-16 視覺與互動更新、2026-06-16 Claude review 追修、2026-06-17 固定房間舊 finished 狀態修正、2026-06-17 Claude bug 清單 A/B/C 修正、開始比賽即時回饋修正，以及主持端清空玩家功能。HTML 目前引用 `styles.css?v=20260617-4` 與 `app.js?v=20260617-4`。
...
- 手機瀏覽器是否載到新版，可在網址後加 `?cache=20260617-4` 或重新掃 QR code。
...
- 部署版 HTML 已更新到 `styles.css?v=20260617-4` 與 `app.js?v=20260617-4`。
- 部署版 `styles.css?v=20260617-4` 與 `app.js?v=20260617-4` 可載入。
...
```html
<script type="module" src="./app.js?v=20260617-4"></script>
```

CSS：

```html
<link rel="stylesheet" href="./styles.css?v=20260617-4" />
```
